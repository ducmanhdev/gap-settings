    ...
    <div class="login__inside">
      <div class="login__left">
        <div class="login__left__title">
          ...
          <p class="text-[32px] font-bold m-0">Setting GCI</p>
...
.login {
  --breakpoint: 640px;
  background: url(@/assets/images/login-top-left.svg) left top no-repeat, url(@/assets/images/login-bottom-right.svg) right bottom no-repeat;
