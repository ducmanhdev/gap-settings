<template>
  ...
  <div v-else class="space-y-4">
    <div>
      <p class="font-medium">Salary by period</p>
    ...
    <div>
      ...
      <a-input-number v-model:value="cardCharge" class="!w-full"/>
    </div>
    <div>
    ...
    <div class="child:flex sm:child:inline-flex space-y-2 sm:space-y-0 sm:space-x-6 child:!min-w-[160px] sm:child:!min-w-[190px]">
