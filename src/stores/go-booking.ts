...
export const useGoBookingStore = defineStore('goBookingStore', {
    ...
    actions: {
        async getBusinessWorkHour(params?: GetBusinessWorkHourRequest): Promise<void> {
        ...
        async updateBusinessWorkHour(data?: UpdateBusinessWorkHourRequest): Promise<void> {
            return new Promise(async (resolve, reject) => {
                try {
        ...
        async getSMSContent(data?: GetSMSContentRequest): Promise<void> {
            return new Promise(async (resolve, reject) => {
                try {
        ...
        async updateSMSContent(data?: UpdateSMSContentRequest): Promise<void> {
            return new Promise(async (resolve, reject) => {
                try {
